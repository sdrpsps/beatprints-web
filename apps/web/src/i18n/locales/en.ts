export const en = {
  ...
  poster: {
    ...
    copiedToastTitle: "Poster copied",
    copiedToastDesc: "Image copied to clipboard. You can paste it directly (Ctrl+V / ⌘V).",
    copyFailedTitle: "Copy failed",
    copyFailedDesc: "Clipboard access was denied or image copying is not supported in this browser.",
    share: "Share",
    sharePoster: "Share poster",
    shareFailed: "Share cancelled or failed",
    historyTitle: "Poster History",
    historyDescription: "Stores the last 20 generated posters. Re-view or restore parameters anytime.",
    historyEmptyTitle: "No poster history",
    historyEmptyDescription: "Generated posters will automatically appear here.",
    restoreSettings: "Restore settings",
    restoredToastTitle: "Settings restored",
    restoredToastDesc: "Loaded this poster's track information, lyrics, and appearance into the studio.",
    viewPoster: "View poster",
    deleteHistoryItem: "Delete",
    clearAllHistory: "Clear all",
    clearHistoryConfirm: "Are you sure you want to clear all poster history? This cannot be undone.",
    historyCountBadge: "{{count}} posters",
    historyOpenAria: "Open poster history panel",
